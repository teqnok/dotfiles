...
keybinds.main = {
    ...
    { "<leader>fo", function() fzf.oldfiles() end, desc = "Find Oldfiles", mode = Modes.Normal },
    { "<leader>fl", function() fzf.lines() end, desc = "Find Lines", mode = Modes.Normal },
    { "<leader>ft", function() fzf.treesitter() end, desc = "Find Symbols [treesitter]", mode = Modes.Normal },
    { "<leader>fL", function() fzf.blines() end, desc = "Find Lines [Buffer]", mode = Modes.Normal },
    ...
    { "<leader>gf", function() fzf.git_files({ prompt = "Git Files >" }) end, desc = "Git Files", mode = Modes.Normal },
    { "<leader>gS", function() fzf.git_stash({ prompt = "Git Stash >" }) end, desc = "Git Stash", mode = Modes.Normal },
    { "<leader>gs", function() fzf.git_status({ prompt = "Git Status >" }) end, desc = "Git Status", mode = Modes.Normal },
    { "<leader>gc", function() fzf.git_commits({ prompt = "Commits >" }) end, desc = "Git Commits", mode = Modes.Normal },
