...
keybinds.__pre = {
    ...
    { "<leader>S", group = "Snacks", icon = { icon = "", color = "green" } },
    { "<leader>S_", hidden = true },
    { "<leader>g", group = "Git" },
...
keybinds.main = {
    ...
    { "<leader>t[", function() Snacks.terminal() end, desc = "New Terminal [Vertical]", mode = Modes.Normal },
    ...
    { "<leader>+", "ggVG", desc = 'Select All', mode = { Modes.Normal, Modes.Visual }, noremap = true, icon = { icon = "󰩬" } },
    ...
    { "<leader>gc", function() Snacks.picker.git_log({preset = "vscode"}) end, desc = "Git Commits", mode = Modes.Normal },
    { "<leader>Sd", function() Snacks.picker.diagnostics({preset = "vscode"}) end, desc = "Diagnostics" },
    { "<leader>SD", function() Snacks.picker.diagnostics_buffer({preset = "vscode"}) end, desc = "Buffer Diagnostics" },
